...
export class CertificationService {
  ...
  updateCertification(certification: any, fileList: NzUploadFile[]) {
    ...
    formData.append("certificationGuid", certification.certificationGuid);
    formData.append("companyGuid", certification.companyGuid);
    formData.append("skillGuid", certification.skillGuid ? certification.skillGuid : '');
    formData.append("certificationIssueDate", certification.certificationIssueDate ? new Date(certification.certificationIssueDate).toISOString() : '');
    formData.append("certificationExpirationDate", certification.certificationExpirationDate ? new Date(certification.certificationExpirationDate).toISOString() : '');
    formData.append("certificationCredentialId", certification.certificationCredentialId ? certification.certificationCredentialId : '');
    formData.append("certificationCredentialUrl", certification.certificationCredentialUrl ? certification.certificationCredentialUrl : '');
    formData.append("certificationDescription", certification.certificationDescription ? certification.certificationDescription : '');
    formData.append("certificationPhotoName", certification.certificationPhotoName);
