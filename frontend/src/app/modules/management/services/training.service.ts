...
export class TrainingService {
  private url = environment.apiUrl + environment.roles.user + environment.routes.trainings;
  ...
  getTrainings(userId: string) {
    if (userId === '') {
      ...
      return this.httpClient.get<ITraining[]>(this.url + environment.routes.getAll+'/' + userId);
    }
  }
